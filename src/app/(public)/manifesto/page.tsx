      ...
      <header className="text-center space-y-6">
        <SlideIn duration={0.5}>
          ...
          <p className="text-muted-foreground text-xl font-bold max-w-xl mx-auto mt-8 leading-relaxed">
            We believe that financial peace shouldn't be a luxury. It should be
            the default.
          </p>
        </SlideIn>
      </header>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-12">
        <FadeIn delay={0.2}>
          <div className="premium-card p-10 rounded-[3rem] border-border/40 h-full">
            ...
            <p className="text-muted-foreground font-medium leading-relaxed">
              Most apps are built to keep you scrolling. We build to get you in,
              recorded, and back to your life. Simple is harder than complex,
        ...
        <FadeIn delay={0.3}>
          <div className="premium-card p-10 rounded-[3rem] border-border/40 h-full">
            ...
            <p className="text-muted-foreground font-medium leading-relaxed">
              You aren't a data point. You're a human being trying to build a
              better future. Every feature we build starts with how it makes you
              feel.
            </p>
          </div>
        </FadeIn>
      ...
      <article className="prose prose-emerald dark:prose-invert max-w-none space-y-8">
        <FadeIn delay={0.4}>
          <h2 className="text-3xl font-black tracking-tight text-foreground">
            Why we built Apna Khata?
          </h2>
          <p className="text-lg text-muted-foreground font-medium leading-8">
            Apna Khata was born out of frustration. Frustration with apps that
            felt like casinos, apps that sold your data, and apps that were so
            complex you needed a degree in finance to use them.
          </p>
          <p className="text-lg text-muted-foreground font-medium leading-8">
            We wanted something elegant. Something that felt like a tool, not a
            trap. A place where you can see your financial truth without the
            noise.
          </p>
          <p className="text-lg text-muted-foreground font-medium leading-8">
            Our mission is simple: To empower every individual with the clarity
            they need to live a life free from financial anxiety.
          </p>
        </FadeIn>
      </article>
          ...
          <div className="relative z-10 space-y-10">
            ...
            <div className="max-w-3xl space-y-8">
              ...
              <div className="space-y-6 text-lg text-muted-foreground font-medium leading-relaxed">
                <p>
                  I still remember watching my father sit with three different
                  paper diaries at the end of every month. He would spend hours
                  trying to reconcile debts, savings, and household expenses. It
                  wasn't just math; it was a visible weight of responsibility on
                  his shoulders.
                </p>
                <p>
                  When I started my own financial journey, I tried the apps. But
                  they felt cold. They were full of ads, or so complicated that
                  I stopped using them after a week. There was no 'soul' in the
                  digital tools that were supposed to help us.
                </p>
                <p>
                  That's why I built **Apna Khata**. I wanted to take that
                  traditional, trustworthy 'Khata' system—the one that has lived
                  in our shops and homes for generations—and give it a modern,
                  elegant digital home.
                </p>
                <p>
                  It's built for humans, not for accountants. No data selling,
                  no hidden traps. Just clarity, heart, and a tool you can
                  actually trust.
                </p>
              </div>
            </div>
      ...
      <FadeIn delay={0.6}>
        <div className="bg-primary/5 rounded-[3rem] p-12 text-center border border-primary/10">
          ...
          <p className="text-muted-foreground font-bold mb-8">
            Ready to take control? It starts with one entry.
          </p>
          <a
            href="/register"
            className="inline-flex items-center justify-center h-14 px-8 rounded-2xl bg-primary text-primary-foreground font-black transition-all hover:scale-105 shadow-xl shadow-primary/20"
          >
            Create Free Account
          </a>
        </div>
