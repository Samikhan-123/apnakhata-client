  ...
  const sections = [
    ...
    },
    {
      ...
      points: [
        ...
        "Locked Months: Previous months locked for editing (90 days rule).",
        "Precision Tracking: Use the filter to access specific range of dates with ease.",
      ],
    },
    {
        ...
        <div className="container relative z-10 mx-auto px-6 text-center">
          <SlideIn duration={0.8}>
            ...
            <p className="max-w-xl mx-auto text-muted-foreground font-medium text-lg leading-relaxed mb-10">
              Everything you need to know about mastering your personal ledger
              and achieving financial sovereignty with Apna Khata.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Link href="/contact">
                <Button
                  variant="ghost"
                  className="h-14 px-10 rounded-2xl font-bold border border-border/40 hover:bg-muted/30 transition-all"
                >
                  Contact Support
                </Button>
              </Link>
              ...
              <FadeIn key={section.title} delay={idx * 0.1}>
                <div className="premium-card p-10 rounded-[3rem] border border-border/10 h-full group hover:border-primary/20 transition-all duration-500">
                  <div className="flex items-start justify-between mb-8">
                    ...
                    <span className="text-[10px] font-black text-muted-foreground/30 uppercase tracking-widest pt-2">
                      Section 0{idx + 1}
                    </span>
                  </div>
                  ...
                  <ul className="space-y-4">
                    {section.points.map((point, pIdx) => (
                      ...
                      >
                        ...
                        <span className="text-sm font-semibold text-foreground/70 leading-relaxed">
                          {point}
                        </span>
                      </li>
                    ))}
            ...
            {[
              {
                ...
                a: "Go to Dashboard > Settings. You can select your base currency from our global list of supported currencies.",
              },
              {
                q: "Is my data private from other users?",
                a: "Yes. Apna Khata follows strict privacy protocols. only you can see your individual record details unless you authorize support.",
              },
              {
                q: "What happens after the 30-day deletion period?",
                a: "After 30 days, your account and all associated records are permanently purged from our primary database and cannot be recovered.",
              },
              {
        ...
        <FadeIn>
          <div className="relative p-12 md:p-20 rounded-[4rem] bg-primary overflow-hidden text-center text-white shadow-2xl shadow-primary/20">
            ...
            <p className="max-w-lg mx-auto text-primary-foreground/70 font-bold mb-10 leading-relaxed text-sm md:text-base relative z-10">
              Join thousands of users who have found financial clarity through
              human-centric design and secure tracking.
            </p>
