    ...
    <div className="max-w-4xl mx-auto px-6 py-24">
      <header className="mb-20 text-center">
        <SlideIn duration={0.5}>
          ...
          <p className="text-muted-foreground font-bold mt-6 italic">
            Simple rules for a better relationship.
          </p>
        </SlideIn>
      </header>
        ...
        <FadeIn delay={0.2}>
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground font-medium leading-relaxed">
              By accessing or using Apna Khata, you agree to be bound by these
              terms. If you do not agree with any part of these terms, you may
              not use our service. We aim to keep these terms as human-readable
              as possible.
            </p>
          </div>
        </FadeIn>
          ...
          <div className="space-y-6 pt-6 border-t border-border/40">
            ...
            <ul className="space-y-4">
              {[
                ...
                <li
                  key={i}
                  className="flex gap-3 text-muted-foreground font-bold text-sm"
                >
