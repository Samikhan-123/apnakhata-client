    ...
    try {
      ...
      if (response.success) {
        toast.success("Account removal initialized", {
          description:
            "Your account is now scheduled for deletion in 30 days. You have been logged out.",
        });
      ...
      toast.error(
        error.response?.data?.message || "Failed to initialize deletion",
      );
    } finally {
      setIsDeleting(false);
      ...
      <Tabs defaultValue="profile" className="w-full">
        <div className="flex xl:flex-row flex-col gap-12">
          ...
          <div className="xl:w-[280px] shrink-0">
            <TabsList className="flex flex-col h-auto bg-transparent border-none p-0 gap-2 items-stretch">
              ...
              >
                ...
                <ChevronRight
                  size={14}
                  className="ml-auto opacity-0 group-data-[state=active]:opacity-100 transition-opacity"
                />
              </TabsTrigger>
          ...
          <div className="flex-1 min-w-0">
            <TabsContent
              value="profile"
              className="m-0 focus-visible:ring-0 animate-in fade-in slide-in-from-right-10 duration-500"
            >
                ...
                <CardContent className="p-8 space-y-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <Label className="text-[11px] font-bold uppercase tracking-wider text-muted-foreground/50 px-1">
                        Full Name
                      </Label>
                      <Input
                        value={user?.name || ""}
                ...
                <CardFooter className="p-8 pt-0">
                  <div className="p-5 rounded-xl bg-primary/5 border border-primary/10 flex items-start gap-3">
                    ...
                    <p className="text-xs font-medium text-muted-foreground/70 leading-relaxed">
                      Profile details are managed by your account provider and
                      cannot be changed here for security.
                    </p>
                  </div>
                </CardFooter>
              </Card>
                  ...
                  <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                      ...
                      <CardDescription className="text-xs font-medium text-muted-foreground/60">
                        Choose how you want to see your money
                      </CardDescription>
                    </div>
                  </div>
                ...
                <Card className="rounded-[2rem] border-border/40 shadow-sm p-8 bg-card">
                  <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                      ...
                      <CardDescription className="text-xs font-medium text-muted-foreground/60">
                        Manage your financial wealth records
                      </CardDescription>
                    </div>
                  </div>
                    ...
                    <div className="p-5 rounded-xl bg-muted/20 border border-muted-foreground/10 flex items-center justify-between gap-6 opacity-40 cursor-not-allowed group">
                      <div>
                        <h5 className="font-bold text-base tracking-tight">
                          Export Platform History
                        </h5>
                        <p className="text-[11px] font-bold text-muted-foreground/40 uppercase tracking-wider italic">
                          Coming Soon...
                        </p>
                      </div>
                      <Button
                        disabled={true}
                        variant="ghost"
                        className="h-10 w-10 rounded-lg p-0 hover:bg-primary/10 hover:text-primary transition-all"
                      >
                        <Download size={18} />
                      </Button>
                    </div>
