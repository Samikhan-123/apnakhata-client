  ...
  const handleGoogleLogin = useGoogleLogin({
    onSuccess: async (tokenResponse) => {
      ...
      try {
        ...
        setServerError(
          err.response?.data?.message || "Google account login failed",
        );
      } finally {
        setLoading(false);
      }
    ...
    const checkStatus = async () => {
      try {
        const { data } = await axios.get(
          `${process.env.NEXT_PUBLIC_API_URL || "http://localhost:5000/api"}/system/status`,
        );
    ...
    <div className="min-h-screen bg-background font-sans">
      ...
      <div className="grid lg:grid-cols-2 min-h-screen pt-20">
        ...
        <div className="hidden lg:flex flex-col justify-center p-24 bg-muted/20 relative overflow-hidden group">
          ...
          <div className="relative z-10 space-y-10">
            ...
            <p className="text-lg text-muted-foreground font-bold max-w-sm leading-relaxed">
              Experience the simplest way to track your expenses and build your
              savings. No difficulty, no complexity.
            </p>
            ...
            <div className="flex items-center gap-10 pt-10">
              ...
              <div className="space-y-1">
                <p className="text-4xl font-black text-foreground tracking-tighter italic text-primary">
                  Precise
                </p>
                <p className="text-[10px] font-black uppercase tracking-widest text-muted-foreground/30">
                  User Centric
        ...
        <div className="flex items-center justify-center p-4 md:p-8 relative overflow-y-auto">
          <FadeIn className="w-full max-w-md flex flex-col gap-4 md:gap-10 premium-card p-6 md:p-14 rounded-[2rem] md:rounded-[3.5rem] border-border/40 shadow-2xl shadow-primary/5 py-8 md:py-12">
            <div className="space-y-3">
              ...
              <p className="text-muted-foreground font-bold text-base leading-snug">
                Log in to reach your savings goals and manage your wealth.
              </p>
            </div>
            ...
            <HeightChange isVisible={isMaintenance}>
              <div className="p-4 rounded-2xl bg-amber-500/5 border border-amber-500/10 flex items-center gap-3 mb-2 animate-pulse">
                ...
                <div>
                  ...
                  <p className="text-[9px] font-bold text-amber-600/60 leading-tight">
                    Standard access restricted. System under optimization.
                  </p>
                </div>
              </div>
            </HeightChange>
                ...
                <div className="space-y-2.5">
                  <div className="flex items-center justify-between px-1">
                    ...
                    <Link
                      ...
                      className="text-[10px] font-black uppercase tracking-widest text-primary/60 hover:text-primary hover:underline transition-colors"
                    >
                      Forgot?
                    </Link>
                  </div>
