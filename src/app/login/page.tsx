...
export const metadata: Metadata = {
  ...
  description:
    "Log in to Apna Khata to manage your income, expenses, budgets, and financial reports in a secure and structured environment.",
  alternates: {
    canonical: "/login",
  },
  openGraph: {
    ...
    description:
      "Access your personal finance dashboard and track your financial activity with ease.",
