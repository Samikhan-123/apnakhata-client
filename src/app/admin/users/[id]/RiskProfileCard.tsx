...
export const RiskProfileCard = ({ riskProfile }: RiskProfileCardProps) => {
  ...
  const {
    ...
    level,
    signals,
    recommendation = "Analyzing signals...",
  } = riskProfile;
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start mb-10 relative z-10 gap-6">
          <div>
            ...
            <p className="text-xs font-bold text-muted-foreground mt-1">
              Real-time analytical trust score.
            </p>
          </div>
          ...
          <div className="flex flex-col items-start sm:items-end w-full sm:w-auto">
            <Tooltip content="Weighted Probability Score">
              ...
              >
                {score}
                <span className="text-xl text-muted-foreground/40 font-bold">
                  %
                </span>
              </div>
            </Tooltip>
            ...
            {signals.map((signal, i) => (
              <SlideIn key={i} delay={i * 0.05}>
                ...
                >
                  ...
                  {signal.impact !== 0 && (
                    <Tooltip
                      content={`${signal.impact > 0 ? "Adds" : "Subtracts"} ${Math.abs(signal.impact)} points from trust baseline`}
                    >
                      <div
                        className={cn(
