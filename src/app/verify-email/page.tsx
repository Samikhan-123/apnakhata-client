  ...
  return (
    <div className="min-h-screen bg-background font-sans">
      ...
      <div className="flex items-center justify-center min-h-screen pt-20 px-4 md:px-6">
        <FadeIn className="w-full max-w-xl premium-card rounded-[2.5rem] md:rounded-[4rem] p-6 md:p-20 border-border/40 shadow-2xl shadow-primary/5 relative overflow-hidden">
          {/* Background Accent */}
          ...
          >
            ...
            <div className="space-y-8 text-center">
              <div className="space-y-4">
                <Label
                  htmlFor="otp"
                  className="text-[10px] font-black uppercase tracking-[0.5em] text-muted-foreground/30"
                >
                  Safety Code
                </Label>
                <Input
