...
import { Mail, ArrowRight, ShieldCheck, CheckCircle2, LifeBuoy } from 'lucide-react'
...
export default function ForgotPasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess("If that email is in our system, we've sent a 6-digit recovery code. Redirecting you...")
      ...
      <div className="flex items-center justify-center min-h-screen pt-20 px-6">
        ...
        >
          <div className="space-y-4 text-center">
            ...
            <h2 className="text-4xl font-black tracking-tighter text-foreground">Lost your password?</h2>
          ...
          <div className="flex items-center justify-center gap-6 opacity-30 grayscale pt-4">
             <div className="flex items-center gap-2">
                <ShieldCheck size={14} />
                <span className="text-[10px] font-black uppercase tracking-widest">Privacy Protection</span>
             </div>
          </div>
        </FadeIn>
      </div>
