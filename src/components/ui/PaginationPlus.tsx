      ...
      typeof p === "number" ? (
        <Button
          ...
          className={cn(
            ...
            currentPage === p
              ? "shadow-lg shadow-primary/20 bg-primary"
        ...
        <span
          key={`dots-${idx}`}
          className="px-2 text-muted-foreground/30 font-black pt-1"
        >
          ...
        </span>
      ),
      ...
      <div className="flex flex-col items-center md:items-start gap-1 group">
        <p className="text-xs font-bold text-muted-foreground/70 transition-colors group-hover:text-primary/60 text-center md:text-left">
          {totalResults ? (
            ...
            <>
              Page{" "}
              <span className="text-foreground font-black">{currentPage}</span>{" "}
              of{" "}
