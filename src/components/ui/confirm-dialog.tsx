      ...
      <DialogContent className="sm:max-w-[440px] rounded-[2.5rem] p-8 border-none bg-background/80 backdrop-blur-3xl shadow-2xl">
        ...
        <DialogFooter className="flex flex-col sm:flex-row gap-3 mt-8">
          ...
          <Button
            variant="destructive"
            onClick={onConfirm}
            className="flex-1 p-4 rounded-2xl h-14 font-bold text-black uppercase tracking-widest text-[10px] bg-rose-500 hover:bg-rose-600 shadow-lg shadow-rose-500/20 border-none"
            disabled={loading}
          >
